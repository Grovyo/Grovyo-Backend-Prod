  ...
  try {
    ...
    if (!user) {
      ...
      const msg = {
        ...
        data: {},
        token:
          "fg-kA3EbSS2HSBA10VCjV1:APA91bHivyjSk3isEtS7qlkFBKDblyX56Kb5VX_2edHsvPmUJHGgwHqPjSaDI4P36yJ5mL0A5OiGYyBcXMfg9zNBfmLU_x48N-yBJWGaXdY0gdH-cEByYGyAeEduWWAfqFXae8KWGPLZ",
      };
